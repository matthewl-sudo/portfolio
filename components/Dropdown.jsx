...
export default function Dropdown({ props, fn }) {
	...
	return (
		<div className="relative sm:w-1/3 sm:max-w-sm w-full inline-block text-right">
			<div className="">
				<button
					type="button"
				...
				>
					Categories
					<svg
						className={`-mr-1 h-5 w-5 text-gray-400 origin-center ${
			...
			{!showMenu && (
				...
				>
					<div className="" role="none">
						{props.map((category, key) => {
							return (
								<button
									...
									className="w-full hover:bg-gray-200 text-gray-700 w-100 block px-4 py-2 text-sm"
									role="menuitem"
									tabIndex="-1"
									id={category.title}
									key={key}
						...
						<button
							href="#"
							className="w-full text-gray-700 block px-4 py-2 text-sm"
							role="menuitem"
							tabIndex="-1"
							id="menu-item-0"
						>
