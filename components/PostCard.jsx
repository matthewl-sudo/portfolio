...
export default function PostCard({data}) {
	...
	<div className="p-4 md:w-1/3">
		<div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
			<img className="lg:h-48 md:h-36 sm:h-24  max-h-64 w-full object-cover object-center" width="100%" src={urlFor(mainImage).url()} alt={mainImage.caption}/>
			<div className="p-6">
				...
				<p className="leading-relaxed capitalize text-xs mb-3">{metaDescription}</p>
