...
function PostCard({data}) {
	...
	<div className="p-4 md:w-1/3">
		<div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
			...
			<div className="p-6">
				<h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY: {categories.map((category,key)=> (<span key={key}>{category.title} </span>))}</h2>
				...
				<div className="flex items-center flex-wrap ">
					<a href={`/blog/${slug.current}`}className="text-purple-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
